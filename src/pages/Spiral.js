...
const spiral = (props) => {
	...
	const draw = (p5) => {
        ...
        p5.pointLight(p5.map(p5.mouseX, 0, p5.width, 190, 255), 200, 60, p5.width/25, p5.height/25, 220)
        p5.pointLight(p5.map(p5.mouseX, 0, p5.width, 190, 255), 200, 60, p5.height/15, p5.height/25)
        p5.pointLight(p5.map(p5.mouseX, 0, p5.width, 190, 255), 200, 60, p5.height -p5.width/15,p5.height - p5.height/15, p5.height/25)
        p5.noStroke()
